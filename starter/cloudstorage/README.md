...
1. General Test
2. User Acceptance Test with JUnit and Selenium
...
- Any errors related to uploadFile actions should be displayed. For example, a user should not be able to upload two
  uploadFiles with the same name, but they'll never know unless you tell them!
